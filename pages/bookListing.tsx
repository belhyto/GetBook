  ...
  const BookListing: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Set the form data to the Firebase Realtime Database
        set(dbRef, formData)
            .then(() => {
                alert('Book listed successfully!');
                // Optionally, you can clear the form fields here or navigate to another page
            })
            .catch((error) => {
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" id="bookName" name="bookName" value={formData.bookName} onChange={handleInputChange} className="form-input" />
              </div>

              {/* Author Name */}
              <div className="flex flex-col">
                <label htmlFor="authorName" className="text-lg font-medium text-gray-800 mb-1">Author Name</label>
                <input type="text" id="authorName" name="authorName" value={formData.authorName}  onChange={handleInputChange} className="form-input" />
              </div>

              {/* Book Description */}
              <div className="flex flex-col">
                <label htmlFor="bookDescription" className="text-lg font-medium text-gray-800 mb-1">Book Description</label>
                <textarea id="bookDescription" name="bookDescription" value={formData.bookDescription}  onChange={handleInputChange} className="form-textarea" />
              </div>
              ...
              <div className="flex flex-col">
                ...
                <input type="text" id="marketPrice" name="marketPrice" value={formData.marketPrice}  onChange={handleInputChange} className="form-input" />
              </div>

              <div className="flex flex-col">
                <label htmlFor="sellingPrice" className="text-lg font-medium text-gray-800 mb-1">Book Selling Price</label>
                <input type="text" id="sellingPrice" name="sellingPrice" value={formData.sellingPrice} onChange={handleInputChange} className="form-input" />
              </div>
              ...
              <div className="flex flex-col">
                ...
                <input type="text" id="dimensions" name="dimensions" value={formData.dimensions}  onChange={handleInputChange} className="form-input" />
              </div>

              <div className="flex flex-col">
                <label htmlFor="weight" className="text-lg font-medium text-gray-800 mb-1">Approximate Weight (in gms)</label>
                <input type="text" id="weight" name="weight" value={formData.weight} onChange={handleInputChange} className="form-input" />
              </div>

              <div className="flex flex-col">
                <label htmlFor="condition" className="text-lg font-medium text-gray-800 mb-1">Condition of Book</label>
                <input type="text" id="condition" name="condition" value={formData.condition} onChange={handleInputChange} className="form-input" />
              </div>

              <div className="flex flex-col">
                <label htmlFor="genre" className="text-lg font-medium text-gray-800 mb-1">Book Genre</label>
                <input type="text" id="genre" name="genre" value={formData.genre}  onChange={handleInputChange} className="form-input" />
              </div>

              <div className="flex flex-col">
    <label htmlFor="language" className="text-lg font-medium text-gray-800 mb-1">Book Language</label>
    <select id="language" name="language" value={formData.language} onChange={handleInputChange} className="form-select">
